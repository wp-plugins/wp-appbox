...
function wpAppbox_add_buttons($buttons) {
	...
	if($options['wpAppbox_enabled_appbox']) array_push($buttons, "separator", "wpAppbox_AppboxButton");
		...
		if($options['wpAppbox_enabled_appworld']) array_push($buttons, "separator", "wpAppbox_BBAppWorldButton");
	}
	return $buttons;
}
...
wp_register_style('wpappbox', plugins_url('css/styles.min.css', __FILE__), array(), '1.1.0', 'screen');
