...
<table class="form-table">
	...
	<tr valign="top">
		...
		<td>	
			<input type="checkbox" name="wpAppbox_affid_sponsored" id="wpAppbox_affid_sponsored" value="1" <?php checked($options['wpAppbox_affid_sponsored']); ?>/> <?php _e('I have no ID at Apple/PHG and would like to use the developer-ID. (In this case: <strong>Thanks!</strong>)', 'wp-appbox'); ?>
		</td>
	</tr>
</table>
...
<table class="form-table">
	...
	<tr valign="top">
		...
		<td>	
			<input type="checkbox" name="wpAppbox_affid_amazonpartnernet_sponsored" id="wpAppbox_affid_amazonpartnernet_sponsored" value="1" <?php checked($options['wpAppbox_affid_amazonpartnernet_sponsored']); ?>/> <?php _e('I have no affiliate ID at Amazon PartnerNet and want to use the ID of the developer. (In this case: <strong>Thank you</strong>!)', 'wp-appbox'); ?>
		</td>
	</tr>
</table>
...
<table class="form-table">
	<tr valign="top">
		...
		<td>	
			<input type="checkbox" name="wpAppbox_user_affiliateids" id="wpAppbox_user_affiliateids" value="1" <?php checked($options['wpAppbox_user_affiliateids']); ?><?php _e('Activates the possibility to use custom affiliate IDs for each user', 'wp-appbox'); ?>
		</td>
	</tr>
</table>