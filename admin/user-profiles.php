					...
					<div id="wpAppbox_user<?php echo($userid); ?>_tradedoubler_div" <?php if(!$options['wpAppbox_user'.$userid.'_tradedoubler_global']) echo 'style="display:none;"'; ?>>
						<p style="margin-left: 24px;">
							<select name="wpAppbox_user<?php echo($userid); ?>_affiliate_apple_service" id="wpAppbox_user<?php echo($userid); ?>_affiliate_apple_service" class="postform" style="min-width:250px;" onchange="javascript:show_hide_apple_affiliate()">
							   <option class="level-0" value="tradedoubler" <?php if($options['wpAppbox_user'.$userid.'_affiliate_apple_service'] == 'tradedoubler') echo 'selected="selected"'; ?>><?php _e('TradeDoubler (TD) - Nur noch bis zum 31. März 2014', 'wp-appbox'); ?></option> 
							   <option class="level-0" value="phg" <?php if($options['wpAppbox_user'.$userid.'_affiliate_apple_service'] == 'phg') echo 'selected="selected"'; ?>><?php _e('Performance Horizon Group (PHG)', 'wp-appbox'); ?></option>
							</select> 
						</p>
						<p style="margin-left: 24px;">
