...
function wpAppbox_options_page() {
	...
	<div class="wrap">
		...
		<?php 
			if($options['wpAppbox_notification'] != '220') {
				echo '<div id="setting-error-settings_updated" class="updated settings-error"><p><strong>'.__('<a href="http://www.blogtogo.de/wp-appbox-2-2-0-benutzerspezifische-affiliate-ids-dauerhafter-cache-und-screenshot-only/" target="_blank">WP-Appbox 2.2.0</a> ist da! Falls Dir das Plugin gefällt, <a href="http://wordpress.org/support/view/plugin-reviews/wp-appbox" target="_blank">bewerte es doch im Plugin-Verzeichnis</a>. :-)', 'wp-appbox').'</strong></p></div>'; 
				$options['wpAppbox_notification'] = '220';
