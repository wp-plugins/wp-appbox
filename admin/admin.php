...
function wpAppbox_options_page() {
	...
	<div class="wrap">
		...
		<?php 
			if($options['wpAppbox_notification'] != '420') {
				echo '<div id="setting-error-settings_updated" class="updated settings-error"><p><strong>'.__('<a href="http://www.blogtogo.de/wp-appbox-2-4-0-bringt-neues-apple-affiliate-programm-mit-und-entfernt-intel-appup/" target="_blank">WP-Appbox 2.4.0</a> ist da! Falls Dir das Plugin gefällt, <a href="http://wordpress.org/support/view/plugin-reviews/wp-appbox" target="_blank">bewerte es doch im Plugin-Verzeichnis</a>. :-)', 'wp-appbox').'</strong></p></div>'; 
				$options['wpAppbox_notification'] = '240';
