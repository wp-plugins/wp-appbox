...
function wpAppbox_adminInit() {
	...
	if(!array_key_exists('wpAppbox_avoid_loadfonts', $settings)) $settings['wpAppbox_avoid_loadfonts'] = '0';
	...
	if(!array_key_exists('wpAppbox_simple_badge_style', $settings)) $settings['wpAppbox_simple_badge_style'] = '1';
...
function wpAppbox_saveSettings() {
	...
	switch($tab) {
    	case 'general':
    		...
    		$settings['wpAppbox_avoid_loadfonts'] = $_POST['wpAppbox_avoid_loadfonts'];
	   	break;
	   	case 'buttons':
	   	...
	   	break;
		case 'banner':
			$settings['wpAppbox_simple_badge_style'] = $_POST['wpAppbox_simple_badge_style'];
