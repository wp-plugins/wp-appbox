	...
	<tr valign="top">
		...
		<td colspan="7">
			<select onChange="javascript:show_hide_table()" name="wpAppbox_button_default" id="wpAppbox_button_default" class="postform">
			   <option <?php if($options['wpAppbox_button_default'] == '0') echo 'selected="selected"'; ?>class="level-0" value="0"><?php _e('Show all App Store button in the editor', 'wp-appbox'); ?></option> 
			   <option <?php if($options['wpAppbox_button_default'] == '1') echo 'selected="selected"'; ?>class="level-0" value="1"><?php _e('Show all App Store button in the editor within the AppBox-Button', 'wp-appbox'); ?></option>
			   <option <?php if($options['wpAppbox_button_default'] == '2') echo 'selected="selected"'; ?>class="level-0" value="2"><?php _e('Show no buttons in the editor', 'wp-appbox'); ?></option>
			   <option <?php if($options['wpAppbox_button_default'] == '3') echo 'selected="selected"'; ?>class="level-0" value="3"><?php _e('Custom Settings', 'wp-appbox'); ?></option>
			</select>
		</td>
	</tr>
</table>
	...
	<?php 
		...
		<tr valign="top">
			<th scope="row"><label for="button_<?php echo $store; ?>"><?php echo($store_names[$store]); ?></label></th>
				...
				<td style="text-align:center;">
					<input name="wpAppbox_button_html_<?php echo $store; ?>" <?php if($options['wpAppbox_button_html_'.$store]) echo 'checked="checked"'; ?><?php if($options['wpAppbox_button_hidden_'.$store]) echo 'disabled="disabled"'; ?>type="checkbox" id="wpAppbox_button_html_<?php echo $store; ?>" value="1" />
				</td>	
				<td style="text-align:center;">
