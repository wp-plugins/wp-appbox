...
<table class="form-table">
	<tr valign="top">
		<th scope="row"><label for="wpAppbox_defaultButton"><?php _e('Button behavior', 'wp-appbox'); ?></label></th>
		<td colspan="7">
			<select onChange="javascript:show_hide_table()" name="wpAppbox_defaultButton" id="wpAppbox_defaultButton" class="postform">
			   <option <?php selected(get_option('wpAppbox_defaultButton'), '0'); ?> class="level-0" value="0"><?php _e('Show all App Store button in the editor', 'wp-appbox'); ?></option> 
			   <option <?php selected(get_option('wpAppbox_defaultButton'), '1'); ?> class="level-0" value="1"><?php _e('Show all App Store button in the editor within the AppBox-Button', 'wp-appbox'); ?></option>
			   <option <?php selected(get_option('wpAppbox_defaultButton'), '2'); ?> class="level-0" value="2"><?php _e('Show no buttons in the editor', 'wp-appbox'); ?></option>
			   <option <?php selected(get_option('wpAppbox_defaultButton'), '3'); ?> class="level-0" value="3"><?php _e('Custom Settings', 'wp-appbox'); ?></option>
			</select>
		</td>
	</tr>
</table>
...
<table id="table_buttons_settings" class="form-table" <?php if(get_option('wpAppbox_defaultButton') != '3') echo 'style="display:none;"'; ?>>
			...
			<tr valign="top">
				...
				<td style="width: 130px; text-align:center;">
					...
					<?php if($th_count == 0) { ?><br /><small>
						<a href="#" onClick="select_buttons_appbox(true);return false;"><?php _e('All', 'wp-appbox'); ?></a> | 
						<a href="#" onClick="select_buttons_appbox(false);return false;"><?php _e('None', 'wp-appbox'); ?></a>
					</small><?php } ?>
				</td>
				<td style="width: 130px; text-align:center;">
					<?php _e('WYSIWYG-View', 'wp-appbox'); ?>
					<?php if($th_count == 0) { ?><br /><small>
						<a href="#" onClick="select_buttons_alone(true);return false;"><?php _e('All', 'wp-appbox'); ?></a> | 
						<a href="#" onClick="select_buttons_alone(false);return false;"><?php _e('None', 'wp-appbox'); ?></a>
					</small><?php } ?>
				</td>
				<td style="width: 130px; text-align:center;">
					<?php _e('HTML-View', 'wp-appbox'); ?>
					<?php if($th_count == 0) { ?><br /><small>
						<a href="#" onClick="select_buttons_text(true);return false;"><?php _e('All', 'wp-appbox'); ?></a> | 
						<a href="#" onClick="select_buttons_text(false);return false;"><?php _e('None', 'wp-appbox'); ?></a>
					</small><?php } ?>
				</td>
				<td style="width: 130px; text-align:center;">
					<?php _e('Hide button', 'wp-appbox'); ?>
					<?php if($th_count == 0) { ?><br /><small>
						<a href="#" onClick="select_buttons_hidden(true);return false;"><?php _e('All', 'wp-appbox'); ?></a> | 
						<a href="#" onClick="select_buttons_hidden(false);return false;"><?php _e('None', 'wp-appbox'); ?></a>
					</small><?php } ?>
				</td>
				<td></td>
			</tr>
	...
	<tr valign="top">
		...
		<td style="width: 130px; text-align:center;"><?php _e('WYSIWYG-View', 'wp-appbox'); ?></td>
