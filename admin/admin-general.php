...
<table class="form-table">
	...
	<!--<tr valign="top">
		<th scope="row"><label for="wpAppbox_no_shorten_title"><?php _e('Titel nicht kürzen', 'wp-appbox'); ?>:</label></th>
		<td>	
			<label for="wpAppbox_no_shorten_title">
				<input type="checkbox" name="wpAppbox_no_shorten_title" value="1" <?php  if($options['wpAppbox_no_shorten_title']) echo 'checked="checked"'; ?> />
				<?php _e('Zeigt immer den vollen App-Titel, auch wenn dieser zu viele Zeichen enthält.', 'wp-appbox'); ?>
			</label>
		</td>
	</tr>-->
	<tr valign="top">
