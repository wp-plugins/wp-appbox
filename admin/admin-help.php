...
<table class="form-table">
	<tr valign="top">
		...
		<td><?php _e('Link to a universal app for iOS, so you can just leave on request show the iPhone or iPad screenshots. For this, <code>-iphone</code> or <code>-ipad</code> can be added to the App ID. Example: <code>[appbox appstore appid-iphone screenshots]</code>', 'wp-appbox'); ?></td>
	</tr>
	<tr valign="top">
