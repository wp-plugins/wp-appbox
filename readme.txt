...
Tags: google play, google, android, apps, apple, app store, ios, windows, windows phone, mobile, windows store, androidpit, blackberry, appworld, appbox, firefox, firefox marketplace, chrome, chrome web store, samsung, samsung apps, amazon, amazon apps, wordpress, opera, steam, intel appup
...
1. Simpler App-Badge mit QR-Code via Mac App Store
2. Compact App-Badge via Firefox Marketplace
3. App-Badge mit Screenshots via App Store
4. Banner-Badge via AndroidPit
5. Video-Badge via Google Play
6. Zoom des QR-Codes
