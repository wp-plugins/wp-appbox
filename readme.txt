...
[Bitte die Optionen nach einem Update auf 1.3.0 prüfen]
...
Die Reihenfolge ist dabei egal - solange "appbox" vorne an steht. Die Storenamen sind dabei: appstore, googleplay, windowsstore, windowsphone, androidpit, blackberryworld, firefoxmarketplace und chromewebstore. Wie ihr an die ID der entsprechenden Apps kommt, findet sich bebildert in den Einstellungen zu WP-Appbox. Das Format ist standardmäßig "simple", alternativ gibt es auch eine Anzeige mit "screenshots" und auch als "banner" (nur für Google Play und AndroidPit).
