...
[Version 1.5.2: Der Firefox Marketplace musste entfernt werden, da Mozilla den Store [grundlegend geändert hat](http://www.blogtogo.de/mozilla-ueberarbeitet-den-firefox-marketplace-und-was-das-fuer-wp-appbox-bedeutet/ "grundlegend geändert hat2") und diese Daten nicht mehr abgegriffen werden können.]
...
Die Reihenfolge ist dabei egal - solange "appbox" vorne an steht. Die Storenamen sind dabei: appstore, googleplay, windowsstore, windowsphone, firefoxaddon, androidpit, samsungapps und chromewebstore. Wie ihr an die ID der entsprechenden Apps kommt, findet sich bebildert in den Einstellungen zu WP-Appbox. Das Format ist standardmäßig "simple", alternativ gibt es auch eine Anzeige mit "screenshots" und auch als "banner" (nur für Google Play und AndroidPit).
...
= 1.5.2 =
* Entfernung der Firefox Marketplace, da  Mozilla keine Möglichkeit mehr bietet, auf die Daten zugreifen zu können
* Codeoptimierungen
