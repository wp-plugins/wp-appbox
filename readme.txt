...
"WP-Appbox" ermöglicht es, via Shortcode schnell und einfach App-Details von Apps aus einer Reihe an App Stores (u.a. (Mac) App Store, Google Play und Windows Store) in Artikeln oder Seiten anzuzeigen.
...
4. Zoom des QR-Codes
5. WP-Appbox Einstellungen Part 1/3
6. WP-Appbox Einstellungen Part 2/3
7. WP-Appbox Einstellungen Part 3/3
8. Artikeleditor mit Buttons
9. Artikeleditor mit kombinierten Buttons
