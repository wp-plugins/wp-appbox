...
Tags: google play, google, android, apps, apple, app store, ios, windows, windows phone, mobile, windows store, androidpit, blackberry, appworld, appbox, firefox, firefox marketplace, chrome, chrome web store, samsung, samsung apps, amazon, amazon apps, wordpress, opera
...
Info: Although the plugin supports multiple languages, the app stores, however, are designed only for German users. If the app stores of other countries are to be used, the URLs must be adapted himself. See the F.A.Q. for more informations.
...
Die Reihenfolge ist dabei egal - solange "appbox" vorne an steht. Die Storenamen sind dabei: androidpit, amazonapps, appstore, chromewebstore, firefoxaddon, firefoxmarketplace, googleplay, operaaddons, samsungapps, windowsphone, windowsstore und wordpress. Wie ihr an die ID der entsprechenden Apps kommt, findet sich bebildert in den Einstellungen zu WP-Appbox. Das Format ist standardmäßig "simple", alternativ gibt es auch eine Anzeige mit "screenshots" und auch als "banner" (nur für Google Play und AndroidPit).
