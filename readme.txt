...
Tags: google play, google, android, apps, apple, app store, ios, windows, windows phone, mobile, windows store, blackberry, appworld, appbox, firefox, firefox marketplace, chrome, chrome web store, samsung, samsung apps, amazon, amazon apps, wordpress, opera, steam, tradedoubler, phg, gog.com, good old games
...
Die Reihenfolge ist dabei egal - solange "appbox" vorne an steht. Die Storenamen sind dabei: amazonapps, appstore, chromewebstore, firefoxaddon, firefoxmarketplace, goodoldgames, googleplay, intelappup, operaaddons, samsungapps, steam, windowsphone, windowsstore und wordpress. Wie ihr an die ID der entsprechenden Apps kommt, findet sich bebildert in den Einstellungen zu WP-Appbox. Das Format ist standardmäßig "simple", alternativ gibt es auch eine Anzeige mit "compact", "screenshots", "screenshots-only", "video" (nur Google Play).
...
4. Banner-Badge (nur WordPress Plugins)
