...
define("WPAPPBOX_PLUGIN_VERSION", '3.1.8');

define("WPAPPBOX_CACHINGTIME", (get_option('wpAppbox_cacheTime') != '' ? get_option('wpAppbox_cacheTime') : $wpAppbox_optionsDefault['wpAppbox_cacheTime'])); 
