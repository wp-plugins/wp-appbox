<?php
	...
	class GetAppInfoAPI {
		...
		function get_store_url($storeID, $appID) {
			...
			elseif((get_option('wpAppbox_storeURL_'.$storeID) == '0') && (get_option('wpAppbox_storeURL_'.$storeID.'_url') != '')) $url = get_option('wpAppbox_storeURL_URL_'.$storeID);
			elseif((get_option('wpAppbox_storeURL_'.$storeID) == '0') && (get_option('wpAppbox_storeURL_'.$storeID.'_url') == '')) $url = $wpAppbox_storeURL[$storeID][1];
			else $url = $wpAppbox_storeURL[$store][get_option('wpAppbox_storeURL_'.$storeID)];
