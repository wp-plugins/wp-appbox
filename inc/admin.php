...
function wpAppbox_adminInit() {
	...
	$settings = array(
		...
		'wpAppbox_affid_affilinet_sponsored' => '0',
		'wpAppbox_affid_amazonpartnernet' => '',
		'wpAppbox_affid_amazonpartnernet_sponsored' => '0',
