	...
	switch($tab){
		case 'general':
			...
			<tr valign="top">
				...
				<td>
					<input type="checkbox" name="wpAppbox_noqrcode" value="1" <?php  if($options['wpAppbox_noqrcode'] == true) echo 'checked="checked"'; ?> /> <span class="description"><?php _e('Blendet sämtliche QR-Codes in den App-Badges aus.', 'wp-appbox'); ?></span>
				</td>
			</tr>
			<tr valign="top">
