...
function wpAppbox_adminInit() {
	...
	$settings = get_option("wpAppbox");
	if(!isset($settings['wpAppbox_piccache'])) $settings['wpAppbox_piccache'] = true;
	if(!isset($settings['wpAppbox_datacache'])) $settings['wpAppbox_datacache'] = false;
	if(!isset($settings['wpAppbox_piccchetime'])) $settings['wpAppbox_piccchetime'] = '300';
	if(!isset($settings['wpAppbox_datacachetime'])) $settings['wpAppbox_datacachetime'] = '300';
	if(!isset($settings['wpAppbox_qrcode'])) $settings['wpAppbox_qrcode'] = '1';
	if(!isset($settings['wpAppbox_affid'])) $settings['wpAppbox_affid'] = '';
	if(!isset($settings['wpAppbox_affid_sponsored'])) $settings['wpAppbox_affid_sponsored'] = '0';
	if(!isset($settings['wpAppbox_affid_affilinet'])) $settings['wpAppbox_affid_affilinet'] = '';
	if(!isset($settings['wpAppbox_affid_affilinet_sponsored'])) $settings['wpAppbox_affid_affilinet_sponsored'] = '0';
	if(!isset($settings['wpAppbox_affid_amazonpartnernet'])) $settings['wpAppbox_affid_amazonpartnernet'] = '';
	if(!isset($settings['wpAppbox_affid_amazonpartnernet_sponsored'])) $settings['wpAppbox_affid_amazonpartnernet_sponsored'] = '0';
	if(!isset($settings['wpAppbox_view_appstore'])) $settings['wpAppbox_view_appstore'] = '0';
	if(!isset($settings['wpAppbox_view_googleplay'])) $settings['wpAppbox_view_googleplay'] = '0';
	if(!isset($settings['wpAppbox_view_androidpit'])) $settings['wpAppbox_view_androidpit'] = '0';
	if(!isset($settings['wpAppbox_view_blackberryworld'])) $settings['wpAppbox_view_blackberryworld'] = '0';
	if(!isset($settings['wpAppbox_view_windowsstore'])) $settings['wpAppbox_view_windowsstore'] = '0';
	if(!isset($settings['wpAppbox_view_windowsphone'])) $settings['wpAppbox_view_windowsphone'] = '0';
	if(!isset($settings['wpAppbox_view_chromewebstore'])) $settings['wpAppbox_view_chromewebstore'] = '0';
	if(!isset($settings['wpAppbox_view_amazonapps'])) $settings['wpAppbox_view_amazonapps'] = '0';
	if(!isset($settings['wpAppbox_view_firefoxaddon'])) $settings['wpAppbox_view_firefoxaddon'] = '0';
	if(!isset($settings['wpAppbox_view_firefoxmarketplace'])) $settings['wpAppbox_view_firefoxmarketplace'] = '0';
	if(!isset($settings['wpAppbox_view_operaaddons'])) $settings['wpAppbox_view_operaaddons'] = '0';
	if(!isset($settings['wpAppbox_view_samsungapps'])) $settings['wpAppbox_view_samsungapps'] = '0';
	if(!isset($settings['wpAppbox_view_wordpress'])) $settings['wpAppbox_view_wordpress'] = '0';
	if(!isset($settings['wpAppbox_nofollow'])) $settings['wpAppbox_nofollow'] = '0';
	if(!isset($settings['wpAppbox_blank'])) $settings['wpAppbox_blank'] = '1';
	if(!isset($settings['wpAppbox_enabled_appstore'])) $settings['wpAppbox_enabled_appstore'] = '1';
	if(!isset($settings['wpAppbox_enabled_googleplay'])) $settings['wpAppbox_enabled_googleplay'] = '1';
	if(!isset($settings['wpAppbox_enabled_windowsstore'])) $settings['wpAppbox_enabled_windowsstore'] = '1';
	if(!isset($settings['wpAppbox_enabled_windowsphone'])) $settings['wpAppbox_enabled_windowsphone'] = '1';
	if(!isset($settings['wpAppbox_enabled_androidpit'])) $settings['wpAppbox_enabled_androidpit'] = '1';
	if(!isset($settings['wpAppbox_enabled_blackberryworld'])) $settings['wpAppbox_enabled_blackberryworld'] = '1';
	if(!isset($settings['wpAppbox_enabled_appbox'])) $settings['wpAppbox_enabled_appbox'] = '0';
	if(!isset($settings['wpAppbox_enabled_chromewebstore'])) $settings['wpAppbox_enabled_chromewebstore'] = '1';
	if(!isset($settings['wpAppbox_enabled_amazonapps'])) $settings['wpAppbox_enabled_amazonapps'] = '1';
	if(!isset($settings['wpAppbox_enabled_firefoxaddon'])) $settings['wpAppbox_enabled_firefoxaddon'] = '1';
	if(!isset($settings['wpAppbox_enabled_firefoxmarketplace'])) $settings['wpAppbox_enabled_firefoxmarketplace'] = '1';
	if(!isset($settings['wpAppbox_enabled_operaaddons'])) $settings['wpAppbox_enabled_operaaddons'] = '1';
	if(!isset($settings['wpAppbox_enabled_samsungapps'])) $settings['wpAppbox_enabled_samsungapps'] = '1';
	if(!isset($settings['wpAppbox_enabled_wordpress'])) $settings['wpAppbox_enabled_wordpress'] = '1';
	if(!isset($settings['wpAppbox_error_parseoutput'])) $settings['wpAppbox_error_parseoutput'] = '0';
	if(!isset($settings['wpAppbox_error_erroroutput'])) $settings['wpAppbox_error_erroroutput'] = '0';
	if(!isset($settings['wpAppbox_add_referrer'])) $settings['wpAppbox_add_referrer'] = '0';
	if(!isset($settings['wpAppbox_no_shorten_title'])) $settings['wpAppbox_no_shorten_title'] = '0';
	if(!isset($settings['wpAppbox_itunes_secureimage'])) $settings['wpAppbox_itunes_secureimage'] = '0';
	if(!isset($settings['wpAppbox_version'])) $settings['wpAppbox_version'] = WPAPPBOX_PLUGIN_VERSION;
