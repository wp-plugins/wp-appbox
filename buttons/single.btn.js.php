...
(function() {
	tinymce.create('tinymce.plugins.wpAppbox_StoreButtons', {
		...
		ed.addButton('wpAppbox_AndroidPitButton', {
			...
			onclick : function() {
				ed.execCommand('mceInsertContent', false, wpAppbox_androidpit_button());
			},
		...
		ed.addButton('wpAppbox_IntelAppUpButton', {
			title : 'Intel AppUp Appbox',
			onclick : function() {
				ed.execCommand('mceInsertContent', false, wpAppbox_intelappup_button());
			},
			image: url + "/intelappup.btn.png"
		});
		...
		ed.addButton('wpAppbox_SamsungAppsButton', {
			...
			onclick : function() {
				ed.execCommand('mceInsertContent', false, wpAppbox_samsungapps_button());
			},
		...
		ed.addButton('wpAppbox_WindowsPhoneButton', {
			title : 'Windows Phone Appbox',
			onclick : function() {
				ed.execCommand('mceInsertContent', false, wpAppbox_windowsphone_button());
			},
			image: url + "/windowsphone.btn.png"
		});
