...
function wpAppbox_androidpit_button() {
	return "[appbox androidpit "+tinyMCE.activeEditor.selection.getContent()+"]";
}
...
function wpAppbox_blackberryworld_button() {
	return "[appbox blackberryworld "+tinyMCE.activeEditor.selection.getContent()+"]";
}
...
function wpAppbox_intelappup_button() {
	return "[appbox intelappup "+tinyMCE.activeEditor.selection.getContent()+"]";
}
...
function wpAppbox_samsungapps_button() {
	return "[appbox samsungapps "+tinyMCE.activeEditor.selection.getContent()+"]";
}
...
function wpAppbox_windowsphone_button() {
	return "[appbox windowsphone "+tinyMCE.activeEditor.selection.getContent()+"]";
}
